...
public class SaveDelegationsResponderInterfaceImpl implements SaveDelegationsResponderInterface {
    ...
    /**
     * Constructor that allows passing a service object to the instance that will alow it to work with underlying resources, db etc.
    ...
    /**
     * Saves a new post or updates an old one. A new is created if no delegation key is found (one is generated by the system and returned with the answer).
