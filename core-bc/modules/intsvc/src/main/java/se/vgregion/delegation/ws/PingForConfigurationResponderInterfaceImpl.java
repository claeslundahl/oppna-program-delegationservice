...
@WebService(serviceName = "PingForConfigurationResponderService", endpointInterface = "se.riv.itintegration.monitoring.rivtabp21.v1.PingForConfigurationResponderInterface", portName = "PingForConfigurationResponderPort",
...
public class PingForConfigurationResponderInterfaceImpl implements PingForConfigurationResponderInterface {
     ...
     *            the service instance that can be used to fulfill the operations supported by this class.
     */
    ...
    @Override
    public PingForConfigurationResponseType pingForConfiguration(String address,
            PingForConfigurationType configurationType) {
